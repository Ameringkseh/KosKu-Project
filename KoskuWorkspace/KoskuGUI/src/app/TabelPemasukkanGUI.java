...
public class TabelPemasukkanGUI extends JFrame {
    private JTable table;
    private DefaultTableModel tableModel;
    private boolean[] hapusVisible;
    private boolean[] editMode;

    public TabelPemasukkanGUI() {
        setTitle("Daftar Pemasukkan");
        setSize(1000, 500);
        ...
        String[] jenisPilihan = {"pemasukkan", "gaji", "bonus", "lainnya"};
                ...
                if (col == 6) {
                    if (!editMode[row]) {
                        ...
                        try {
                            ...
                            Pemasukkan p = new Pemasukkan(id, sumber, jenis, jumlah, tanggal, catatan);
                            PemasukkanService.update(p);
                    ...
                    if (confirm == JOptionPane.YES_OPTION) {
                        int id = (int) tableModel.getValueAt(row, 0);
                        PemasukkanService.deletePemasukkan(id);
